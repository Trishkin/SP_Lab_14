...
int main(int argc, char** argv)
{
	...
	try
	{
		...
		{
			std::cout << "OS14_START does not work \n";
			system("pause");
			return -1;

		}
		//HashTable::HTHANDLE* HT = OS13::HashTableLib::Open(h1, argv[1]);
		HashTable::HTHANDLE* HT = OS13::HashTableLib::Open(h1, "D:\\1\\Lab_14\\Debug\\HashTable.ht");
		if (HT == NULL) throw "Invalid handle";
		hf = CreateFile(L"D:\\1\\Lab_14\\update.log", GENERIC_WRITE | GENERIC_READ, NULL, NULL, OPEN_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
